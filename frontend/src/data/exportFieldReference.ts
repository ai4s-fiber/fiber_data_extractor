...
export const EXPORT_SHEET_REFERENCES: ExportSheetRef[] = [
  {
    ...
    subtitle: '主数据表（40 列）',
    description:
      '每一行是一条可独立交付的完整材料数据记录，包含文献、样品、成分、工艺、结构、性能与原文证据。其它 Sheet 保留更细粒度的溯源信息。',
    fields: [
      { no: 1, en: 'record_id', zh: '数据记录编号', meaning: '每一行数据的唯一编号' },
      { no: 2, en: 'paper_id', zh: '文献编号', meaning: '指向 Papers 表的文献编号，如 P0001' },
      { no: 3, en: 'paper_title', zh: '文献标题', meaning: '当前记录所属论文的完整标题' },
      { no: 4, en: 'doi_or_url', zh: 'DOI/链接', meaning: '论文 DOI 或可访问链接' },
      { no: 5, en: 'year', zh: '发表年份', meaning: '论文发表年份' },
      { no: 6, en: 'journal', zh: '期刊', meaning: '论文发表期刊' },
      { no: 7, en: 'sample_group_id', zh: '样品组编号', meaning: '同一组变量实验的编号' },
      ...
      { no: 11, en: 'variable_name', zh: '变量名称', meaning: '该组样品主要变化的因素' },
      { no: 12, en: 'variable_value', zh: '变量数值', meaning: '当前样品对应的变量值' },
      { no: 13, en: 'variable_unit', zh: '变量单位', meaning: '变量单位，如 wt%、℃、×、min、m/min' },
      { no: 14, en: 'composition_expression', zh: '成分表达式', meaning: '完整成分配方' },
      { no: 15, en: 'matrix_name', zh: '基体/前驱体名称', meaning: '主体材料名称，如 PET、PVDF、PAN、PA6' },
      { no: 16, en: 'matrix_content', zh: '基体/前驱体含量', meaning: '主体材料含量' },
      { no: 17, en: 'matrix_unit', zh: '基体/前驱体单位', meaning: '主体材料含量单位，如 wt%、vol%、mol%' },
      { no: 18, en: 'additive_expression', zh: '填料/改性组分表达式', meaning: '填料、增强相、功能组分信息' },
      { no: 19, en: 'solvent_or_aid', zh: '溶剂/助剂', meaning: '溶剂、分散剂、相容剂、加工助剂等' },
      { no: 20, en: 'composition_evidence', zh: '成分证据', meaning: '支撑配方与组成字段的原文' },
      { no: 21, en: 'process_route', zh: '工艺路线', meaning: '总体制备路线' },
      { no: 22, en: 'spinning_method', zh: '纺丝方法', meaning: '具体纺丝方法，如 melt spinning、wet spinning、electrospinning' },
      { no: 23, en: 'process_parameters', zh: '工艺参数', meaning: '关键工艺参数' },
      { no: 24, en: 'post_treatment', zh: '后处理条件', meaning: '退火、热牵伸、碳化、稳定化、洗涤、干燥等后处理' },
      { no: 25, en: 'process_evidence', zh: '工艺证据', meaning: '支撑工艺与后处理字段的原文' },
      ...
      { no: 28, en: 'structure_evidence', zh: '结构证据', meaning: '支撑结构表征字段的原文' },
      ...
      { no: 31, en: 'performance_value', zh: '性能数值', meaning: '性能指标对应的数值' },
      { no: 32, en: 'performance_unit', zh: '性能单位', meaning: '性能单位，如 MPa、%、GPa、S/m、pC/N、V' },
      { no: 33, en: 'performance_method', zh: '性能测试方法', meaning: '测试方法或标准' },
      { no: 34, en: 'performance_condition', zh: '性能测试条件', meaning: '测试条件，如 gauge_length=20 mm; tensile_speed=10 mm/min' },
      { no: 35, en: 'performance_evidence', zh: '性能证据', meaning: '支撑当前性能数值的原文' },
      { no: 36, en: 'extraction_method', zh: '抽取方式', meaning: '生成该记录的解析器与模型模式' },
      { no: 37, en: 'evidence_text', zh: '核心证据原文', meaning: '可直接核查当前记录的完整原文证据' },
      { no: 38, en: 'ai_confidence', zh: 'AI 置信度', meaning: '该条记录的抽取可信度，通常为 0–1' },
      { no: 39, en: 'review_status', zh: '审核状态', meaning: '待审核、已修改、通过、存疑、缺失、已删除' },
  ...
  },
  {
    ...
    subtitle: '证据明细表（12 列）',
    description:
      '每条证据对应文献中的一个文本/表格/图注片段，含完整 evidence_text。通过 record_id 与 Main_Data 关联。',
    fields: [
      { no: 1, en: 'evidence_id', zh: '证据编号', meaning: '证据明细行的唯一 ID' },
